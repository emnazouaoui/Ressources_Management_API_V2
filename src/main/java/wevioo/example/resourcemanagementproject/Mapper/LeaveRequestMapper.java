...
public interface LeaveRequestMapper {
    ...
    LeaveRequestDTO LeaveRequestToLeaveRequestDTO(LeaveRequest entity);

    @Mapping(target = "user",           ignore = true)
    @Mapping(target = "projectManager", ignore = true)
    LeaveRequest LeaveRequestDTOtoLeaveRequestEntity(LeaveRequestDTO dto);

    // pour update
    @Mapping(target = "user",           ignore = true)
    @Mapping(target = "projectManager", ignore = true)
    void LeaveRequestDTOtoLeaveRequestEntity(LeaveRequestDTO dto, @MappingTarget LeaveRequest entity);
}